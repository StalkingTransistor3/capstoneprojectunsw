...
import Footer from '../components/WaitStaffFooter';
...
const DashboardWaitStaff = () => {
  ...
  const handleNextButtonClick = (tableNo, tableId) => {
    ...
    navigate('/dashboardwait/foodDashboard');
  };
  ...
  return (
    <>
      <div className="customer-home-page-wrapper">
        ...
        >
          <div className="dashboard-header-title-padding">Active Orders</div>
          ...
          {error ? (
            ...
            <div className="waitstaff-recommendations-box">
              {tables && tables.length > 0 ? (
                tables.map((table) => (
                  ...
                  >
                    <div className="icon-container">
                      ...
                      ) : table.Status === StatusEnum.SERVED ? (
                        <div className="w-support-button-grey">
                          <ChefHatIcon />
                        </div>
                      ) : (
                ...
                <RecommendationsBox>
                  <h4>No active tables at the moment :)</h4>
                </RecommendationsBox>
              )}
            </div>
          )}
...
export default DashboardWaitStaff;
